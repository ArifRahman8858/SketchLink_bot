...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if "https://sketchfab.com/3d-models" in text:
        ...
        await update.message.reply_text(
            "Step 1: Click Link 1 and stay at least 20 seconds, then click 'Next'.",
...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "next_after_link1":
        ...
        if not start_time or (now - start_time).total_seconds() < 20:
            await query.edit_message_text("⏱️ Please wait at least 20 seconds on the first link before continuing.")
            return
        ...
        await query.edit_message_text(
            "✅ Step 1 complete! Now click Link 2 and stay for 15 seconds.",
            reply_markup=keyboard
        )
        ...
        if model_link:
            ...
            await query.edit_message_text("✅ Your link has been successfully sent to the channel.")
        else:
